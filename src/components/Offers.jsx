    ...
    <>
      ...
      <div className="boxes-holder" id="offers">
        <div className="box">
          ...
          <h2>
            <strong><a href="mailto: office@wetog.de">Termin vereinbaren</a></strong>
          </h2>
        </div>
        <div className="box">
          <h1>Vorort Audit</h1>
      ...
      <div className="kost-box__holder">
        <div className="kost-box">
          ...
          <p>
            Wir finden Ihr perfektes und individuelles Angebot. Vereinbaren Sie
            jetzt ein kostenloses Vorgespräch.
          </p>
          <p>
            <strong><a href="mailto: office@wetog.de">Jetzt vereinbaren</a></strong>
          </p>
        </div>
      </div>
    </>
