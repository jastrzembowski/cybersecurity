      ...
      <div className="main-container" onClick={(e) => unCheck()}>
        ...
        <div className="about-box">
          ...
          <div className="main-button nav-img">
            <p><a href="mailto: office@wetog.de">Learn more</a></p>
          </div>
          {isHidden && (<div className="main-button nav-img__small"   onClick={(e) => setIsHidden(!isHidden)}>
            <span><strong>Mehr Erfahren</strong></span></div> )}
            {!isHidden && (  <span className="small-text-box" >  <br />
            <br />
        ...
        <div className="reaction-box">
          ...
          <div className="main-button react-img">
            <p><a href="https://www.bmi.bund.de/SharedDocs/downloads/DE/publikationen/themen/it-digitalpolitik/bsi-lagebericht-cybersicherheit-2021.pdf?__blob=publicationFile&v=3">Download 10 Schritte pdf</a></p>
          </div>
        </div>
        <Path/>
        <Offers/>
